...
class Lead(Base):
    ...
    operational_model: Mapped[str | None] = mapped_column(String, nullable=True)
    primary_goal: Mapped[str | None] = mapped_column(String, nullable=True)
    overall_score: Mapped[int | None] = mapped_column(Integer, nullable=True)
    recommended_tier: Mapped[str | None] = mapped_column(String, nullable=True)
    gap_count: Mapped[int | None] = mapped_column(Integer, nullable=True)
    top_gap: Mapped[str | None] = mapped_column(String, nullable=True)
    pain_points: Mapped[str | None] = mapped_column(String, nullable=True)
    after_hours_method: Mapped[str | None] = mapped_column(String, nullable=True)
