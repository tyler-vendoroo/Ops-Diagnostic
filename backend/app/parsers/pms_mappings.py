...
# Category normalization — merge PMS category variants into standard trade names
CATEGORY_NORMALIZE = {
    "HVAC/Plumbing": "HVAC",
...
# Trade coverage map — maps required trade names to PMS category variants
TRADE_COVERAGE_MAP = {
    "Plumbing":         ["Plumbing", "HVAC/Plumbing", "Water Heater Repair/Replacement"],
    "Electrical":       ["Electrical"],
    "Rooter/Drain":     ["Plumbing", "Rooter/Drain"],
    "Appliance Repair": ["Appliances", "Appliance Repair"],
    "General Handyman": ["Handyperson", "General Contractor", "Handyman", "General Handyman"],
    "HVAC":             ["HVAC", "HVAC/Plumbing"],
    "Roofing":          ["Roofing"],
    "Pest Control":     ["Pest Control"],
    "Landscaping":      ["Landscaping"],
    "Locksmith":        ["Keys/Locks", "Locksmith"],
    "Cleaning Service": ["Cleaning Service", "Cleaning", "Reno Custom Cleaning", "Smart Clean"],
...
VENDOR_TRADE_KEYWORDS = {
    ...
    "General Handyman": ["handyman", "handy", "need a hand", "maintenance"],
    "Cleaning Service": ["cleaning", "clean", "maid", "janitorial"],
